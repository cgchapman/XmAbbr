...
${\color{blue}peopleList:}$  <br>
          ${\color{blue}-name:}$  <br>
                    ${\color{blue}-title: \space \color{red}Mr \space \color{blue}firstname: \space \color{red}John \space \color{blue}middlename: \space \color{red}Albert \space \color{blue}lastname: \space \color{red}Doeson}$ ${color{blue}gender: \space \color{red}Male}$  <br>
